...
- 9개 취향 축과 주력 게임 선호를 이용한 12문항 성향 테스트
- 테스트 응답·주력 게임 선호·최애 및 2단계 관계도를 조합한 추천 결과 5명 (최애 지정 시 추가 추천은 최애 관계 우선, 미지정 시 BEST 관계 우선)
...
- 추천 가중치: 마지막 질문의 `favoriteWeight`, `similarity()`, `RELATION_BONUS_BY_DEPTH`
